...
urlpatterns = [
    ...
    path("performance-chart/<oferta>/<cue>/",performance_chart,name="performance-chart"),
    path("performance-chart/<oferta>/",performance_chart,name="performance-chart"),
    path("total-score-chart/<oferta>/<cue>/",total_score_chart,name="total-score-char"),
    path("total-score-chart/<oferta>/",total_score_chart,name="total-score-char"),
    path("math-ability-chart/<oferta>/<cue>/",math_ability_chart,name="math-ability-chart"),
    path("math-ability-chart/<oferta>/",math_ability_chart,name="math-ability-chart"),
    path("lan-ability-chart/<oferta>/<cue>/",lan_ability_chart,name="lan-ability-chart"),
    path("lan-ability-chart/<oferta>/",lan_ability_chart,name="lan-ability-chart"),
    path("cn-ability-chart/<oferta>/<cue>/",cn_ability_chart,name="cn-ability-chart"),
    path("cn-ability-chart/<oferta>/",cn_ability_chart,name="cn-ability-chart"),
    path("cs-ability-chart/<oferta>/<cue>/",cs_ability_chart,name="cs-ability-chart"),
    path("cs-ability-chart/<oferta>/",cs_ability_chart,name="cs-ability-chart"),
    path("participation-chart/<oferta>/<cue>/",participation_chart,name="participation-chart"),
    path("participation-chart/<oferta>/",participation_chart,name="participation-chart"),
    path("full-participation/<oferta>/<cue>/",full_participation,name="full-participation"),
